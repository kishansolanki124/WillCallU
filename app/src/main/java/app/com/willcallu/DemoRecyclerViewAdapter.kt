...
class DemoRecyclerViewAdapter(private val context: Context,
                              private val upcomingReqestsArraylist: ArrayList<IconModel>) :
        RecyclerView.Adapter<DemoRecyclerViewAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.profile_icon_item, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bindForecast(upcomingReqestsArraylist[position], context)
    }
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bindForecast(upcomingRequest: IconModel, context: Context) {
            ...
            if (upcomingRequest.isSelected) {
                ...
                itemView.fab.background.setColorFilter(ContextCompat.getColor(context, R.color.colorControlHighlight),
...
//                            ColorStateList.valueOf(ContextCompat.getColor(context, R.color.colorControlHighlight)))
                ...
                itemView.fab.background.setColorFilter(ContextCompat.getColor(context, R.color.gray),
                        PorterDuff.Mode.MULTIPLY)
